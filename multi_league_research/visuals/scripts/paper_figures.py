...
FINAL_TABLE_DIR = PROJECT_ROOT / "multi_league_research" / "visuals" / "final_report" / "tables"
POOLED_SELECTION_DIR = (
    PROJECT_ROOT / "multi_league_research" / "visuals" / "pooled_feature_selection" / "tables"
)
...
ROBUSTNESS_TABLE_DIR = (
    PROJECT_ROOT / "multi_league_research" / "visuals" / "robustness_checks" / "tables"
)
